# Lab 01-A - Konnect Control Plane + Local Data Plane

> **Goal:** Create a Konnect Control Plane, download the Data Plane certificates, and run a local Docker Data Plane that connects to Konnect. Verify the hybrid connection is healthy.

::: info Hybrid Architecture
**Control Plane (CP)** → Konnect cloud. Manages all configuration.  
...
# Expected:
# Successfully Konnect'd to Kong! (version: 3.9.x.x)
```
...
**Next:** [🚀 Lab 01-B - First API Call →](./01-first-api-call)
